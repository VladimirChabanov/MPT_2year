...
4. Напишите ad hoc команду ansible, чтобы на хостах состоящих в группе  "thor", который состоит **только** в группах "avengers" и "asgard" с паролем "Strongest Avenger".
